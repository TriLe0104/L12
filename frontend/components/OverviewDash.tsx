    ...
    <section className="overview-dash">
      <div className="summary-strip">
        ...
        <div>
          ...
          <small>
            {power
              ? `${formatKw(power.active.stranded_kw)} stranded · ${power.mode === "dynamic" ? "Dynamic Power Mode" : "static"}`
      ...
      <div className="gauge-row">
        ...
        <Gauge
          ...
          detail={
            power
              ? `${formatKw(power.envelope_kw ?? power.budget_kw)} envelope · static ${power.racks_static_max ?? 0} · Dynamic Power Mode ${power.racks_lps_max ?? 0}${power.racks_lps_gain ? ` (+${power.racks_lps_gain})` : ""} · [${Math.round(power.min_rack_kw ?? 40)}–${Math.round(power.max_rack_kw ?? 300)}] kW`
